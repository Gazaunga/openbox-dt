...
echo "<item label=\"Run in terminal\"><action name=\"Execute\"><execute>urxvt -e '$file' -t '$file'</execute></action></item>"
echo "<item label=\"Edit in emacs\"><action name=\"Execute\"><execute>urxvt -e 'emacs $file'</execute></action></item>"
echo "    </menu>"
done
echo "    </menu>"
